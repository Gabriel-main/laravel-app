...
<body class=" font-sans antialiased flex flex-col md:flex-row min-h-screen">

    <livewire:layout.navigation />
    <main class="animate-view flex-1 p-4 md:p-6 w-full md:w-auto overflow-x-hidden" wire:key="{{ Request::url() }}">
        {{ $slot }}
    </main>
    ...
    <div x-data="{
        ...
        <div class="bg-gray-900/95 text-white rounded-2xl shadow-2xl p-4 flex items-center gap-3 border backdrop-blur-md transition-colors duration-500 max-w-sm w-full"
            ...
            <div class="shrink-0 w-10 h-10 rounded-full flex items-center justify-center bg-white/10">
